...
bn1 = batch_norm_wrapper(m1, is_training) 
z1 = tf.nn.leaky_relu(bn1)

m2 = tf.matmul(z1, w2) + b2
bn2 = batch_norm_wrapper(m2, is_training)
z2 = tf.nn.leaky_relu(bn2)
...
for epoch in range(max_epoch) :
    ...
    ## predict op needs to be fed with x because it calls y_ which is tf.matmul(z1,w2) + b2 where z1 is defined as a function of x
