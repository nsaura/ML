...
\begin{frame}{Introduction}{Big data in fluid mechanics}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\sarrow High fidelity datasets from Direct Numerical Simulation \normalsize or Lattice Boltzmann method\\[1mm]
...
\begin{frame}{Introduction}{Precision or cost computation ?}
	\checkmark \hspace{2mm} Powerful computers allow to investigate highly complexed Turbulent flows. Then two choices 
	\begin{itemize}
