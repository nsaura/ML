...
\begin{frame}{Introduction}{Data-Driven methods and Supervised Machine learning}
	\begin{block}{The aim of data-driven methods}
	...
	\begin{block}{Supervised Machine Learning as an inference problem}	
...
\textit{Maximum A Posteriori} method : gives  $\beta_M$ through an iterative process  
