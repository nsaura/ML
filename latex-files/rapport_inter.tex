...
\begin{document}
	\begin{titlepage} \centering
		\begin{minipage}[ht]{0.7\textwidth}
			\centering
			\includegraphics[scale=1.5]{logo_lmfl_large.png} \hfill
			\includegraphics[scale=0.5]{univ_lille_logo.png}
		\end{minipage}
...
%Dans un ordre de précision, les méthodes dites de LES (Large Eddy Scales) suivent les DNS. Schématiquement, cette catégorie de méthodes résout les équations de Navier-Stokes sur les grandes et moyennes échelles. Les actions des petites échelles sont modélisées 	.\\
