...
Le filtre qui est un tableau de valeurs, est convolué avec le receptive field courant, les 75 ($5\times5\times3$) valeurs sont sommées dans une seule case de la première HL. En réitérant cette convolution, on construit une \textit{\textbf{channel}}, \textit{\textbf{activation map}} ou encore \textit{\textbf{feature map}} (définitions équivalentes sauf pour l'input composée de channels) de forme ($32-5+1$, $35-5+1$, $1$) = ($28$, $28$, $1$).\\
...
\begin{wrapfigure}[7]{r}{3cm} \vspace{-8mm}
\centering
