...
Le filtre qui est un tableau de valeurs, est convolué avec le receptive field courant, les 75 ($5\times5\times3$) valeurs sont sommées dans une seule case de la première HL (voir figure). En réitérant cette convolution, on construit une \textit{activation map} autrement appelée \textit{feature map} de forme ($32-5+1$, $35-5+1$, $1$) = ($28$, $28$, $1$). \\
