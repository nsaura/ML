...
\graphicspath{{./pic/}}	% Root directory of the pictures 
...
\definecolor{bgColorOne}{RGB}{186,215,230}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Utility functions %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%	\fbox{
		\begin{minipage}{14em}
			\includegraphics[width=10em,height=4em]{logo_lmfl_border.png}
...
\includegraphics[scale=0.25]{AC_graph.png}
}
